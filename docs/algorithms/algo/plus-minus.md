...
> There are \\(n = 5\\) elements: two positive, two negative and one zero. Their
  ratios are \\(\frac{2}{5} = 0.400000\\), \\(\frac{2}{5} = 0.400000\\) and
...
- [Solution](https://github.com/hanggrian/grind-hackerrank/blob/main/algorithms/src/main/java/algo/PlusMinus.java)
